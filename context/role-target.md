...
> This is the one file I customize per company I apply to. Everything else in the repo stays constant. Currently filled with placeholder/example structure, so fill in real company details before sending.
