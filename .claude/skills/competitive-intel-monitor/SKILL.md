...
- **mohitagw15856/pm-claude-skills**, `pm-gtm/competitor-teardown`: the evidence-citation requirement: every claim (there, a SWOT bullet; here, a battlecard line) must cite a specific data point, minimum 3 source types per competitor.
...
- **Pricing**: $89/seat/mo listed on flowbase.io/pricing, screenshot dated 2026-06-23. Source: website.
- **Product**: added a native Slack integration per their changelog, dated 2026-06-15. Source: website (changelog page).
- **Hiring**: 3 open "Enterprise AE" postings on their careers page as of 2026-06-23, up from 0 last quarter: signals an upmarket push. Source: job postings.
...
Trigger: pricing-page monitoring (intended integration) would have caught this; in this demo, Marcus pasted a screenshot showing $75/seat/mo, dated 2026-06-30.

```
Flowbase - event-triggered update (pricing change) - 2026-06-30

RED - Pricing: list price dropped $89 → $75/seat/mo (16% cut), source:
flowbase.io/pricing screenshot dated 2026-06-30. Second cut in two
...
No other dimensions changed since the 2026-06-23 baseline.
```
