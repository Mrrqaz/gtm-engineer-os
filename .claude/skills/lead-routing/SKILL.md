...
|---|---|
| **Subscriber** | Opted into any list (newsletter, resource download) with no fit data yet, or fit data present but below Low tier and no sales-relevant action taken. |
